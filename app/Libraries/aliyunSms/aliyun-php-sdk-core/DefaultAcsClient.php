...
{	
	...
	private function buildApiException($respObject, $httpStatus)
	{
		if(500 <= $httpStatus)
		{
			throw new ServerException($respObject->Message, $respObject->Code,$respObject->status_code = 500);
		}
		else
		{
			return new ClientException($respObject->Message, $respObject->Code,$respObject->status_code = 404);
