...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">商户贴纸申请列表 <small>header small text goes here...</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        ...
                        @if(auth('admin')->user()->can('merchantCode.add'))
                        <a href="{{ url('admin/merchantCode/create') }}">
                        ...
                        <table class="table table-bordered table-hover" id="treeTable">
                            ...
                            <tr>
                                ...
                                <th style="width: 20%;">收件人名字</th>
                                <th style="width: 20%;">地址</th>
                                <th style="width: 20%;">电话</th>
                                <th style="width: 20%;">备注</th>
                                <th style="width: 20%;">贴纸是否寄送</th>
                                <th style="width: 20%;">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($merchantAddress['data'] as $data)
                            <tr id="{{ $data['id'] }}"  >
                                ...
                                <td>{{ $data['tel'] }}</td>
                                <td>{{ $data['remark']}}</td>
                                <td>{{ ($data['is_send'] ==1) ? '未寄送' : '已寄送'}}</td>
                                <td>{!! $data['button'] !!}</td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
                        {!! $merchantAddress['page']->render() !!}
                    </div>
                </div>
                <!-- end panel -->
            </div>
