...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">商户管理员列表 <small>header small text goes here...</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        ...
                        @if(auth('admin')->user()->can('merchantAdmin.add'))
                        <a href="{{ url('admin/merchantAdmin/create') }}">
                        ...
                        <table class="table table-bordered table-hover" id="treeTable">
                            ...
                            <tbody>
                            @foreach($merchantAdmin['data'] as $data)
                            <tr id="{{ $data['id'] }}"  >
                                <td>{{ $data['merchant_name'][0]['merchant_name'] }}</td>
                                <td>{{ $data['nickname'] }}</td>
