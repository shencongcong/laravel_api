                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/adminuser') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="email" name="email" placeholder="邮箱（将会作为登录名）" data-parsley-required="true" data-parsley-required-message="请输入邮箱"  data-parsley-type="email" data-parsley-type-message="邮箱格式不正确" value="{{ old('email') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
