...
namespace Tymon\JWTAuth\Facades { 
    ...
    class JWTAuth {
         ...
         * @static 
         */ 
        public static function createToken($sub = 1, $customClaims = array())
        {
            return \Tymon\JWTAuth\JWTAuth::createToken($sub, $customClaims);
        }
         ...
         * @static 
         */ 
        public static function getTokenData($token = false)
        {
            return \Tymon\JWTAuth\JWTAuth::getTokenData($token);
        }
         ...
         * @static 
         */ 
        public static function getExpTime($token = false)
        {
            return \Tymon\JWTAuth\JWTAuth::getExpTime($token);
        }
